...
const ctx1 = canvas1 === null || canvas1 === void 0 ? void 0 : canvas1.getContext("2d");
...
const traffic = [
    new Car({
        x: road.getLaneCenter(1),
        y: 300
    }, 50, 100, "assets/dummycar.png", "DUMMY", 2),
    new Car({
...
function generateCars(n) {
    ...
    for (let i = 0; i < n; i++) {
        cars.push(new Car({
            x: road.getLaneCenter(1),
            y: 500
        }, 50, 100, "assets/car.png", "AI", 3));
    }
    return cars;
}
const saveButton = document.getElementById("save");
const clearButton = document.getElementById("clear");
saveButton === null || saveButton === void 0 ? void 0 : saveButton.addEventListener("click", (e) => {
    saveBrain();
});
...
function animate() {
    ...
    bestCar = cars.find(car => car.getPos().y == Math.min(...cars.map(car => car.getPos().y)));
    canvas1.height = window.innerHeight;
    ctx1.save();
